              ...
              <nav id="nav-menu-container">
                <ul class="nav-menu">
                  <li class="menu-has-children"><a href="">Activity</a>
                    <ul>
                      <li><a href="submitRequestForm?studentID=${STUDOBJ.studentID}">Send Request</a></li>
                  ...
                  <li class="menu-has-children"><a href="">${STUDOBJ.studentName}</a>
                    <ul>
                      <li><a href="updateStudentForm?studentID=${STUDOBJ.studentID }">Edit Profile</a></li>
