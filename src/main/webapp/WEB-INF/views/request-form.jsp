...
<body>
	...
	<script>
		function onChangeInstituteName(id) {
			var courseId = 0;
			var courseName = "Select Course";
			if(id == 500) {
				courseId = 300;
				courseName = "PHD(CourseID - 300)";
			} else if(id == 501) {
				courseId = 301;
				courseName = "CSE(CourseID - 301)";
			} else if(id == 502) {
				courseId = 302;
				courseName = "MCA(CourseID - 302)";
			} else if(id == 503) {
				courseId = 303;
				courseName = "MBA(CourseID - 303)";
			} else if(id == 504) {
				courseId = 304;
				courseName = "ECE(CourseID - 304)";
			}
			var course = document.getElementById("courseID")
			course.innerHTML = "<option readonly value=" + courseId + ">" + courseName + "</option>"
		}
	</script>
