...
public class InstituteDAOImpl implements InstituteDAO {
	...
	public boolean updateInstitute(Institute institute) {
		boolean b = false;
		String query = "UPDATE institute SET instituteName = ? , affiliationDate = ? , address = ?, seats = ? WHERE instituteID = ?";
		...
		try {
			...
			int count = jdbcTemplate.execute(query, new PreparedStatementCallback<Integer>() {
				...
				public Integer doInPreparedStatement(PreparedStatement ps) 
					...
					ps.setInt(5,  institute.getInstituteID());
	...
	public boolean addNewInstitute(Institute institute) {
		boolean b = false;
		String query = "INSERT INTO institute(instituteName, institutePassword, affiliationDate,  address, seats) VALUES(?,?,?,?,?)";
	...
	public List<Request> getAllRequests(int instituteID) {
		...
		String query = "SELECT requestID, userID, instituteID, courseID, requestDate, status FROM admissionrequest "
